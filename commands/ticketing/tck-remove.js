...
// Class for the tck-remove command
module.exports = class TckRemoveCommand extends BlueCommand {
    // Constructor
    constructor(client) {
        // Build the command data
        super(client, "tck-remove");
    }
    ...
    async run(interaction) {
        ...
        // If the ticket was found, remove the user's access to the ticket channel
        ticketChannel.permissionOverwrites.edit(user.id, {
            ViewChannel: false
        });

        // Build the response message
        const msg = new BlueMessage(this.client, "user-removed", locale, {
            user_id: user.id,
