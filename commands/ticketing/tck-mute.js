...
module.exports = class TckUnmuteCommand extends BlueCommand {
    ...
    async run(interaction)  {
        ...
        // If the ticket was found, prevent the user from sending messages in the ticket
        ticketChannel.permissionOverwrites.edit(user.id, {
            SendMessages: false
        });

        // Build the response message
        const msg = new BlueMessage(this.client, "user-muted", locale, {
            user_id: user.id,
